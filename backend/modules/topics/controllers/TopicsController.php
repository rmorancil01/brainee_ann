...
namespace backend\modules\topics\controllers;

use Yii;
use backend\modules\topics\models\Topics;
use backend\modules\topics\models\TopicsSearch;
...
class TopicsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'topic_id' => $model->topic_id]);
        }
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($topic_id)
    {
        $model = $this->findModel($topic_id);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($topic_id)
    {
        $this->findModel($topic_id)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($topic_id)
    {
        if (($model = Topics::findOne($topic_id)) !== null) {
            return $model;
        }
